...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --as='gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang' --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.4.sdk --extra-ldflags=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.4.sdk/usr/lib/system --target-os=darwin --arch=x86_64 --disable-yasm --disable-neon --prefix=x64_32 --extra-cflags='-arch x86_64 -miphoneos-version-min=6.0' --extra-ldflags='-arch x86_64 -miphoneos-version-min=6.0' --enable-pic --enable-cross-compile --enable-gpl --disable-iconv --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-network --disable-encoders --disable-decoders --disable-muxers --disable-parsers --disable-bsfs --disable-protocols --disable-devices --disable-filters --disable-debug --enable-decoder=h264 --enable-decoder=mpeg4 --enable-decoder=mjpeg --enable-muxer=mov --enable-muxer=avi --enable-muxer=tgp --enable-protocol=file
prefix=x64_32
...
CC_IDENT=Apple LLVM version 6.1.0 (clang-602.0.53) (based on LLVM 3.6.0svn)
ARCH=x86
INTRINSICS=none
...
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=ar
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.4.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.4.sdk -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC -DZLIB_CONST
CFLAGS=  -arch x86_64 -miphoneos-version-min=6.0 -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch x86_64 -miphoneos-version-min=6.0 -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.4.sdk/usr/lib/system -arch x86_64 -miphoneos-version-min=6.0  --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.4.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator8.4.sdk -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
